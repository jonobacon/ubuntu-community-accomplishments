...
// ACCOMPLISHMENT: Signed Ubuntu Code Of Conduct
//
// ENGLISH TRANSLATION: The Ubuntu Code Of Conduct is an important document that provides a set of guidelines and expectations for good conduct in the Ubuntu Community.
...
// ACCOMPLISHMENT: Signed Ubuntu Code Of Conduct
//
// ENGLISH TRANSLATION: First generate a PGP key, add it to the Ubuntu key-server, and import it into Launchpad. See <a href="https://help.launchpad.net/YourAccount/ImportingYourPGPKey">here</a> for how to do this.
