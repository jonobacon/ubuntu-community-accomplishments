...
// ACCOMPLISHMENT: Filed Bug that was Confirmed
//
// ENGLISH TRANSLATION: File a bug as you would normally (see the Filed First Bug accomplishments for more details) and ensure that the description is detailed enough to enable others to reproduce it. To write a good bug report, include the following:
...
// ACCOMPLISHMENT: Filed Bug that was Confirmed
//
// ENGLISH TRANSLATION: http://www.ubuntu.com
